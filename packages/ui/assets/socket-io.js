...
!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e) {
      ...
      function o(t) {
        return (
          i(t, u, 'day') || i(t, c, 'hour') || i(t, a, 'minute') || i(t, s, 'second') || t + ' ms'
        );
      }
      function i(t, e, n) {
        if (!(t < e))
      ...
      (function(e) {
        function r(t, n) {
          ...
          (n = n || {}),
            ...
            (this.secure =
              null != n.secure ? n.secure : e.location && 'https:' === location.protocol),
            n.hostname && !n.port && (n.port = this.secure ? '443' : '80'),
            (this.agent = n.agent || !1),
            (this.hostname = n.hostname || (e.location ? location.hostname : 'localhost')),
            (this.port =
              n.port || (e.location && location.port ? location.port : this.secure ? 443 : 80)),
            (this.query = n.query || {}),
    ...
    function(t, e, n) {
      (function(t) {
        ...
        (e.encodePacket = function(e, n, i, a) {
          ...
          return (
            void 0 !== e.data &&
              (u += i ? d.encode(String(e.data), { strict: !1 }) : String(e.data)),
            a('' + u)
          );
        }),
